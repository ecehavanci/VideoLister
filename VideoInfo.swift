...
//  VideoLister
//
//  Created by Ece Havanci on 8.07.2023.
//
...
struct videoInfo{
    static let listOfVideos:[Video] = [
        ...
        Video (imageName: "hired", title: "Hired's 2020 State of Software Engineering", uploadDate: "February 13"),
        ...
        Video (imageName: "nav-controller", title: "ios Navigation Controller Tutorial", uploadDate: "March 28, 20"),
